      ...
      <main className="mx-auto max-w-6xl px-4 py-10">
        ...
        <section className="mt-14 grid gap-4 lg:grid-cols-2" id="roommates">
          <div className="rounded-2xl border border-slate-800 bg-slate-900/40 p-6">
            <SectionHeading
              eyebrow="Browse & Match Roommates"
              title="Compatibility Scoring Engine"
              description="System ranks potential roommates by lifestyle similarity (0-100% compatibility). Algorithm considers: schedules, cleanliness, social habits, noise preferences, and guest policies."
            />
            <div className="grid gap-4 sm:grid-cols-2 mt-4">
              <div className="rounded-xl border border-slate-800 bg-slate-950 p-4">
                <span className="text-xs text-emerald-400 font-bold uppercase tracking-wide">Average Match Time</span>
                <strong className="mt-1 block text-2xl">2.6 mins</strong>
              </div>
              <div className="rounded-xl border border-slate-800 bg-slate-950 p-4">
                <span className="text-xs text-emerald-400 font-bold uppercase tracking-wide">Success Rate</span>
                <strong className="mt-1 block text-2xl">94%</strong>
                <span className="text-xs text-slate-500">safe compatibility</span>
              </div>
            </div>
            <div className="mt-6 flex flex-wrap gap-2">
              <button
                ...
                type="button"
                onClick={() => onNavigateToPage('roommate/dashboard')}
              >
                Find Roommates Now
              </button>
            </div>
